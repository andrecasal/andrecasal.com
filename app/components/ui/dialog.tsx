...
>(({ asChild, className, children, ...props }, ref) => {
	return (
		<DialogPrimitive.Close
			...
			asChild={asChild}
			className={cn(
				'absolute right-4 top-4 rounded-sm opacity-70 ring-offset-background transition-opacity hover:opacity-100 focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 disabled:pointer-events-none data-[state=open]:bg-accent data-[state=open]:text-muted-500',
				className,
			)}
			{...props}
		>
