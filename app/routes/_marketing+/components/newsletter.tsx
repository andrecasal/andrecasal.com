			...
			<div className="relative isolate pb-16 pt-8 sm:pb-24 sm:pt-12 lg:pb-32 lg:pt-16">
				<div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 lg:max-w-none lg:grid-cols-2">
					<div className="flex max-w-xl flex-col justify-between lg:max-w-lg">
						...
						<p className="mt-4 text-body-md leading-8 text-muted-400">Subscribe to the newsletter to get notified when new articles are published.</p>
					...
					<dl className="grid grid-cols-1 gap-x-8 gap-y-10 sm:grid-cols-3 lg:pt-2">
						<div className="flex flex-col items-start">
							...
							<dd className="mt-2 leading-7 text-muted-600">Learn about the best solutions and alternatives to common problems.</dd>
						</div>
						<div className="flex flex-col items-start">
							<div className="rounded-md bg-foreground/5 p-2 ring-1 ring-foreground/10">
							...
							<dd className="mt-2 leading-7 text-muted-600">I provide you with useful code you can copy+paste.</dd>
						</div>
						<div className="flex flex-col items-start">
							<div className="rounded-md bg-foreground/5 p-2 ring-1 ring-foreground/10">
							...
							<dd className="mt-2 leading-7 text-muted-600">Stay updated with the latest insights in full-stack web dev.</dd>
						</div>
					</dl>
				</div>
			</div>
