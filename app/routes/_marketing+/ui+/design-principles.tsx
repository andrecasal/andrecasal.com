...
const DesignPrinciples = () => {
	return (
		<div className="max-w-2xl">
			...
			<Text className="mt-4">For interface design, an alternative and more practical approach is to hand-pick the font sizes. This is the approach I took for this library.</Text>
			...
			<Text className="mt-4">Even though you have complete control to change this, I chose to apply fluid typography, with a simple process:</Text>
			<ul className="ml-4 mt-4 list-disc">
