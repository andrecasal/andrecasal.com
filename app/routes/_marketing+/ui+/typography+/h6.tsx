...
import { H6 } from '../components/typography/h6.tsx'
...
const component: componentProps = {
	...
	fileName: 'h6',
	category: 'typography',
	description: ['An h6 element with control for typographic attributes.'],
	features: ['Drop-in replacement for the native <h6> element.', 'Automatically inherits design tokens.', 'Allows control of size, weight, alignment, and tracking.'],
	parts: [
		{
			name: 'H6',
			description: 'An h6 element.',
			props: [
	...
	usage: `<H6 size="6xl">H6 6xl</H6>
<H6 size="5xl" weight="thin">
	H6 5xl
</H6>
<H6 size="4xl" align="center">
	H6 4xl
</H6>
<H6 size="3xl" align="right" tracking="widest">
	H6 3xl
</H6>
<H6 size="2xl">H6 2xl</H6>
<H6 size="xl">H6 xl</H6>
<H6 size="lg">H6 lg</H6>
<H6 size="md">H6 md</H6>
<H6 size="sm">H6 sm</H6>
