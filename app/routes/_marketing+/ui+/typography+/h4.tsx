...
const component: componentProps = {
	...
	fileName: 'h4',
	category: 'typography',
	description: ['An h4 element with control for typographic attributes.'],
	features: ['Drop-in replacement for the native <h4> element.', 'Automatically inherits design tokens.', 'Allows control of size, weight, alignment, and tracking.'],
	parts: [
		{
			name: 'H4',
			description: 'An h4 element.',
			props: [
				{ name: 'weight', type: 'enum: black, extrabold, bold, semibold, medium, normal, light, extralight, thin', default: 'bold' },
				{ name: 'size', type: 'enum: 4xl, 3xl, 2xl, xl, lg, md, sm, xs', default: 'xl' },
	...
	usage: `<H4 size="6xl">H4 6xl</H4>
<H4 size="5xl" weight="thin">
	H4 5xl
</H4>
<H4 size="4xl" align="center">
	H4 4xl
</H4>
<H4 size="3xl" align="right" tracking="widest">
	H4 3xl
</H4>
<H4 size="2xl">H4 2xl</H4>
<H4 size="xl">H4 xl</H4>
<H4 size="lg">H4 lg</H4>
<H4 size="md">H4 md</H4>
<H4 size="sm">H4 sm</H4>
