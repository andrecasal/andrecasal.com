...
const component: componentProps = {
	...
	fileName: 'h1',
	category: 'typography',
	description: ['An h1 element with control for typographic attributes.'],
	features: ['Drop-in replacement for the native <h1> element.', 'Automatically inherits design tokens.', 'Allows control of size, weight, alignment, and tracking.'],
	parts: [
		{
			name: 'H1',
