...
import { H5 } from '../components/typography/h5.tsx'
...
const component: componentProps = {
	...
	fileName: 'h5',
	category: 'typography',
	description: ['An h5 element with control for typographic attributes.'],
	features: ['Drop-in replacement for the native <h5> element.', 'Automatically inherits design tokens.', 'Allows control of size, weight, alignment, and tracking.'],
	parts: [
		{
			name: 'H5',
			description: 'An h5 element.',
			props: [
				{ name: 'weight', type: 'enum: black, extrabold, bold, semibold, medium, normal, light, extralight, thin', default: 'bold' },
				{ name: 'size', type: 'enum: 4xl, 3xl, 2xl, xl, lg, md, sm, xs', default: 'lg' },
	...
	usage: `<H5 size="6xl">H5 6xl</H5>
<H5 size="5xl" weight="thin">
	H5 5xl
</H5>
<H5 size="4xl" align="center">
	H5 4xl
</H5>
<H5 size="3xl" align="right" tracking="widest">
	H5 3xl
</H5>
<H5 size="2xl">H5 2xl</H5>
<H5 size="xl">H5 xl</H5>
<H5 size="lg">H5 lg</H5>
<H5 size="md">H5 md</H5>
<H5 size="sm">H5 sm</H5>
