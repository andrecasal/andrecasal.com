		...
		<>
			...
			<Container className="py-32">
				<div className="max-w-3xl text-muted-700">
					...
					<Text heading="h2" size="3xl" className="mt-2 text-muted-900 sm:text-size-4xl">
						College life
					</Text>
					...
					<div className="mt-10 max-w-2xl">
						...
						<Text heading="h3" size="2xl" className="mt-16 text-muted-900">
			...
			<Container className="py-24 sm:py-32">
				<div className="mx-auto max-w-2xl lg:text-center">
					...
					<Text size="3xl" className="mt-2 font-bold text-muted-900 sm:text-size-4xl">
						Successful student
					</Text>
					<Text size="lg" className="mt-6 text-muted-600">
			...
			<Container className="pt-14">
				<div className="py-24 sm:py-32 lg:flex lg:items-center lg:gap-x-10 lg:py-40">
					<div className="mx-auto max-w-2xl lg:mx-0 lg:flex-auto">
						<Text heading="h2" size="4xl" className="mt-10 max-w-lg text-muted-900 sm:text-size-6xl">
