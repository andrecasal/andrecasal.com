	...
	return (
		<Container>
			<div className="py-24 sm:py-32">
				...
				<p className="mt-2 text-lg leading-8 text-muted-600">Learn how to grow your business with expert advice.</p>
						...
						<article key={talk.id} className="relative isolate flex flex-col gap-8 lg:flex-row">
							...
							<div>
								...
								<div className="group relative max-w-xl">
									...
									<p className="mt-5 text-sm leading-6 text-muted-600">{talk.description}</p>
								</div>
								<div className="mt-6 flex border-t border-muted-900/5 pt-6">
									<div className="relative flex items-center gap-x-4">
										...
										<div className="text-sm leading-6">
											<p className="font-semibold text-muted-900">
