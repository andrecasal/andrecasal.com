...
import { requireRecentVerification, type VerifyFunctionArgs } from '#app/routes/_auth+/verify.server.ts'
	...
	return (
		<E.Html lang="en" dir="ltr">
			<E.Container>
				...
				<p>
					<E.Text>We're writing to let you know that your Epic Notes email has been changed.</E.Text>
				</p>
				<p>
					<E.Text>
