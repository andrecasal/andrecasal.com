...
export default function EditUserProfile() {
	...
	return (
		<Container>
			<div className="m-auto mb-36 mt-16 max-w-3xl">
				...
				<div className="mt-16 flex flex-col gap-12">
					<div className="flex justify-center">
						<div className="relative h-52 w-52">
							<img src={getUserImgSrc(data.user.imageId)} alt={data.user.username} className="h-full w-full rounded-full object-cover" />
					...
					<Form method="POST" {...form.props}>
						<div className="grid grid-cols-6 gap-x-10">
							...
							/>
							<Field className="col-span-3" labelProps={{ htmlFor: fields.name.id, children: 'Name' }} inputProps={conform.input(fields.name)} errors={fields.name.errors} />
							<Field
								className="col-span-3"
							...
							<fieldset className="col-span-6">
								<legend className="pb-6 text-size-lg">Change password</legend>
							...
							<Link preventScrollReset to="two-factor" className="col-span-full flex gap-1">
						...
						<div className="mt-8 flex justify-center">
							<StatusButton type="submit" size="wide" status={isSubmitting ? 'pending' : actionData?.status ?? 'idle'}>
								Save changes
							</StatusButton>
						</div>
					</Form>
