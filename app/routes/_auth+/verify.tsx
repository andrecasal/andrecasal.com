...
export default function VerifyRoute() {
	...
	const checkEmail = (
		<>
			...
			<p className="text-body-md text-muted-foreground mt-3">We've sent you a code to verify your email address.</p>
		</>
	)
	...
	const headings: Record<VerificationTypes, React.ReactNode> = {
		...
		'2fa': (
			<>
				...
				<p className="text-body-md text-muted-foreground mt-3">Please enter your 2FA code to verify your identity.</p>
			</>
		),
	}
